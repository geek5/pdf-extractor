...
class TextWriter extends FileWriter {
	...
	getFilePathForPage(page) {
		return super.getPagePath(page.pageNumber, 'annotation.json');
	}

	writeCanvasPage(page, viewport, canvas) {
		// console.log('getAnnotations', page.pageNumber)
		...
		// 			return this.writeStringToFile(JSON.stringify(data), this.getFilePathForPage(page));
		// 			process.exit(1);
		// 		}
		// 	})
		// });
